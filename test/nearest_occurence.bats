...
@test "event is today" {
  run nearest_occurence "2001-01-01" "2001-01-01" "year" "1"
...
@test "event in the future: its always its own nearest occurence" {
  run nearest_occurence "2001-01-01" "2004-01-01" "year" "1"
...
@test "weekly event: two days later" {
  run nearest_occurence "2000-01-03" "2000-01-01" "week" "1"
...
@test "weekly event: five days later" {
  run nearest_occurence "2000-01-06" "2000-01-01" "week" "1"
...
@test "biweekly event: five days later" {
  run nearest_occurence "2000-01-06" "2000-01-01" "week" "2"
...
@test "biweekly event: eight days later" {
  run nearest_occurence "2000-01-09" "2000-01-01" "week" "2"
...
@test "monthly event: a week later" {
  run nearest_occurence "2000-01-08" "2000-01-01" "month" "1"
...
@test "monthly event: three weeks later" {
  run nearest_occurence "2000-01-22" "2000-01-01" "month" "1"
...
@test "bimonthly event: three weeks later" {
  run nearest_occurence "2000-01-22" "2000-01-01" "month" "2"
...
@test "bimonthly event: five weeks later" {
  run nearest_occurence "2000-02-05" "2000-01-01" "month" "2"
...
@test "yearly event: exactly a year later" {
  run nearest_occurence "2001-01-01" "2000-01-01" "year" "1"
...
@test "yearly event: 8 months later" {
  run nearest_occurence "2000-09-01" "2000-01-01" "year" "1"
...
@test "yearly event: 5 months later" {
  run nearest_occurence "2000-06-01" "2000-01-01" "year" "1"
...
@test "biyearly event: 8 months later" {
  run nearest_occurence "2000-09-01" "2000-01-01" "year" "2"
...
@test "biyearly event: 12 months later" {
  run nearest_occurence "2001-01-01" "2000-01-01" "year" "2"
...
@test "one-time event: months after" {
  run nearest_occurence "2000-06-01" "2000-01-01" "one_time" "1"
...
@test "one-time event: years after" {
  run nearest_occurence "2009-06-01" "2000-01-01" "one_time" "1"
